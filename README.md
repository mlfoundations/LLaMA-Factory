...
[23/09/10] We supported **[FlashAttention-2](https://github.com/Dao-AILab/flash-attention)**. Try `attn: fa2` argument to enable FlashAttention-2 if you are using RTX4090, A100 or H100 GPUs.
