...
extra_require = {
    ...
    "deepspeed": ["deepspeed>=0.17.2,<=0.18.0"],
    ...
    "mcore": [
        ...
        "megatron-bridge",
        "megatron-core",
        "mcore_adapter @ git+https://github.com/penfever/roll.git#subdirectory=mcore_adapter",
    ],
    "minicpm_v": [
        "soundfile",
        "torchvision",
    ...
    "openmind": ["openmind"],
    "swanlab": ["swanlab"],
    "dev": ["pre-commit", "ruff", "pytest", "build", "openai"],
    "cce": ["cut-cross-entropy @ git+https://github.com/apple/ml-cross-entropy.git"],
